...
![Added methods to the car park class](images/methods_to_car_park1.png)
![Added methods to the car park class](images/methods_to_car_park2.png)
...
1. Add a screenshot of the output of the `main.py` file:
   ...
   ![Main.py output](images/main_py.png)
